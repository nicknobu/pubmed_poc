# services/evaluation.py 完全修正版
"""論文要約の品質評価機能（多言語対応・エラー修正版）"""
...
class SummaryEvaluator:
    ...
    def calculate_multilingual_word_overlap(self, text1: str, text2: str) -> float:
        ...
        # 基本的な単語重複も考慮
        basic_overlap = self.calculate_word_overlap(text1, text2)
    ...
    def extract_abstract(self, text: str) -> Optional[str]:
        ...
        # Method 3: 冒頭部分推定
        return self._extract_from_beginning_debug(lines)
